# https://github.com/mwc2dh/DS2002-Lab-3
...
# create and commit database tables
...
# insert users and orders into database
...
# return first 3 results of query
cur.execute("SELECT * FROM users;")
